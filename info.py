...
API_ID = int(environ.get('28638866')
API_HASH = environ.get('a748074bea1e6ace57394aceb194d292')
BOT_TOKEN = environ.ger('Fuck')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002523558100').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6969391120').split()]
...
QR_CODE_IMG = environ.get('QR_CODE_IMG','https://envs.sh/Yor.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', 'son491413-2okhdfcbank') #enter your upi id here - grab it from your online payment methods.
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adda™](https://t.me/Tamil_LinksZzz)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
DISCUSSION_CHAT_USRNM = "Tamil_LinksZzz" #without @
...
CAPTION_BUTTON_URL = "https://t.me/Tamil_LinksZzz"
